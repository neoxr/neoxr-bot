exports.run = {
   ...
   async: async (m, {
      ...
      try {
         if (!args || !args[0]) return client.reply(m.chat, Func.example(isPrefix, command, 'https://podcasts.google.com/feed/aHR0cHM6Ly9hbmNob3IuZm0vcy9iOTRlYWMwL3BvZGNhc3QvcnNz/episode/NGY4M2VmYTktMTMzZi00ZTZmLWJjNmItYmZiZmU3NjQyNTMy'), m)
