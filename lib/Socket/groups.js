...
const extractGroupMetadata = (result) => {
    ...
    if (descChild) {
        ...
        descTime = parseInt(descChild.attrs.t);
    }
    ...
    const metadata = {
        ...
        participants: (0, WABinary_1.getBinaryNodeChildren)(group, 'participant').map(({ attrs }) => {
            var _a;
            return {
                id: ((_a = group === null || group === void 0 ? void 0 : group.attrs) === null || _a === void 0 ? void 0 : _a.addressing_mode) === 'lid' ? attrs.phone_number : attrs.jid,
