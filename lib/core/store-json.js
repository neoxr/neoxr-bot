...
class Store {
    constructor(dir = 'stores', max = 250, debug = false) {
        ...
        this.groupMetadataFilePath = node_path_1.default.join(this.storeDir, 'group_metadata.json');
    ...
    loadGroupMetadataData() {
        try {
            if (node_fs_1.default.existsSync(this.groupMetadataFilePath)) {
                const content = node_fs_1.default.readFileSync(this.groupMetadataFilePath, 'utf-8');
                const list = parse(content);
                list.sort((a, b) => (b.updated_at || 0) - (a.updated_at || 0));
    ...
    writeGroupMetadataData() {
        if (this.groupMetadataPendingWrite)
            return;
        ...
        this.schedule(2000, () => {
            ...
            this.enqueueWrite('group_metadata', async () => {
                ...
                try {
                    await node_fs_1.default.promises.writeFile(tempPath, stringify(list), 'utf-8');
                    await node_fs_1.default.promises.rename(tempPath, this.groupMetadataFilePath);
