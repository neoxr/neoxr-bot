...
const myCache = new node_cache_1.default({ stdTTL: 300, checkperiod: 60 });
function getCachedQuotedMessage(quotedId) {
    const cached = myCache.get(quotedId);
    if (cached) {
        return cached;
    }
    return null;
}
function setCachedQuotedMessage(quotedId, quotedMessage) {
    myCache.set(quotedId, quotedMessage);
}
const MIMETYPE_MAP = {
    image: 'image/jpeg',
    video: 'video/mp4',
...
const generateWAMessageFromContent = (jid, message, options) => {
    ...
    if ((_a = quoted === null || quoted === void 0 ? void 0 : quoted.key) === null || _a === void 0 ? void 0 : _a.id) {
        const quotedId = quoted.key.id;
        let quotedMsg = getCachedQuotedMessage(quotedId);
        if (!quotedMsg) {
            // Jika tidak ada data di cache, ambil data baru
            const participant = ((_b = quoted === null || quoted === void 0 ? void 0 : quoted.key) === null || _b === void 0 ? void 0 : _b.fromMe) ? userJid : (quoted.participant || ((_c = quoted === null || quoted === void 0 ? void 0 : quoted.key) === null || _c === void 0 ? void 0 : _c.participant) || ((_d = quoted === null || quoted === void 0 ? void 0 : quoted.key) === null || _d === void 0 ? void 0 : _d.remoteJid));
            quotedMsg = (0, exports.normalizeMessageContent)(quoted.message);
            ...
            contextInfo.stanzaId = (_e = quoted === null || quoted === void 0 ? void 0 : quoted.key) === null || _e === void 0 ? void 0 : _e.id;
            contextInfo.quotedMessage = quotedMsg || {};
            // if a participant is quoted, then it must be a group
            // hence, remoteJid of group must also be entered
            if (jid !== ((_f = quoted === null || quoted === void 0 ? void 0 : quoted.key) === null || _f === void 0 ? void 0 : _f.remoteJid)) {
                contextInfo.remoteJid = (_g = quoted === null || quoted === void 0 ? void 0 : quoted.key) === null || _g === void 0 ? void 0 : _g.remoteJid;
            }
            innerMessage[key].contextInfo = contextInfo;
            // Simpan ke cache setelah diproses
            setCachedQuotedMessage(quotedId, contextInfo);
        }
        else {
            // Jika data baru adalah null, gunakan data yang ada di cache
            // console.log('Using cached quoted message');
            innerMessage[key].contextInfo = quotedMsg;
        }
    }
    // if (quoted) {
