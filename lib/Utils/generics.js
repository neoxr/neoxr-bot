...
const generateMessageIDV2 = (userId) => {
    ...
    // Mengembalikan substring pertama dari hash dengan panjang 22 karakter
    return hash.toString('hex').toUpperCase().substring(0, 22); // Menghasilkan ID dengan panjang 22 karakter
};
exports.generateMessageIDV2 = generateMessageIDV2;
const generateMessageID = () => (0, crypto_1.randomBytes)(11).toString('hex').toUpperCase().slice(0, 22);
